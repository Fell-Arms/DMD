BEGIN
	...
	VALUES
	(NEWID(), @User_Id1, @Race_Id1, 1, 'Bobby', 'Bobbinson', 18, 3, 
	...
	(NEWID(), @User_Id2, @Race_Id2, 2, 'Meatball', 'Gravydog', 18, 3, 
	'Shunned from the elven community, Meatball Gravydog took up residence with the trolls and received a new name.', 340, 'meatball-gravydog.png' ),

	(NEWID(), @User_Id3, @Race_Id3, 3, 'Synthia', 'Greywall', 18, 3, 
	'A hero from the north, Synthia travels to spread her name and create a vast fortune for an early retirement.', 1080, 'synthia-greywall.png' )
END